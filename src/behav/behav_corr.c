...
uint32_t	ltime;
int16_t	*xy;
int32_t		x = INT_MIN,y = INT_MIN;			/* current position */
int32_t		x1,y1;			/* current position of diode 1 */
int32_t		x2,y2;			/* current position of diode 2 */
int32_t		px = INT_MIN,py = INT_MIN;			/* prev position of diode 1 */
int32_t		px2 = INT_MIN,py2 = INT_MIN;		/* prev position of diode 2 */
int32_t		i,j;
uint32_t	startstamp;
int32_t		prevdirection;		/* previous direction */
int32_t		newdirection = INT_MIN;		/* current direction */
uint32_t	newptimestamp;		/* current timestamp */
int32_t		d = INT_MIN;
int32_t		n;
int32_t		intervalcount;
double		corr = INT_MIN;
int32_t		hasdirection;
int32_t		deldir;
int32_t		velocityang;		/* velocity angle of diode 1 */
int32_t		velocityang2;		/* velocity angle of diode 2 */
...
int32_t		vmagdiff;
int32_t		firstvalid;
int32_t		changedirection;
int32_t		changeposition;
int32_t		occupancydirection;
int32_t		skip_position;
int32_t		min,sec;
int32_t		mintheta,maxtheta;
	...
	*/
	ComputeCoordinates((int32_t)xy[0],(int32_t)xy[1],result,&x1,&y1);
	/*
	** compute diode 2 coordinates in the grid coordinate system
	*/
	ComputeCoordinates((int32_t)xy[2],(int32_t)xy[3],result,&x2,&y2);
