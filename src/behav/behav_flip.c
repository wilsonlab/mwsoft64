...
** to compare against
*/
int32_t CountFlips(j,testdirection,plist,lookahead)
int32_t		j;
int32_t		testdirection;
PositionList	*plist;
int32_t		lookahead;
{
int32_t	flipcount;
...
** to compare against
*/
int32_t TestFlip(plist,newdirection,j,lookahead)
PositionList	*plist;
int32_t		newdirection;
int32_t		j;
int32_t		lookahead;
