...
int32_t	convert;
    ...
    */
	...
	if(binaryformat){
	    ...
	    */
	    if(fread(&timestamp,sizeof(uint32_t),1,result->fpin) != 1) break;
	    if(convert){
...
** 0 otherwise
*/
int32_t CheckRange(result,index)
Result	*result;
int32_t	index;
{
int32_t	j;
